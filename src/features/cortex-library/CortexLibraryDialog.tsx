        ...
        <div className="flex h-full">
          ...
          <div className="w-[220px] border-r border-[var(--text-primary)]/5 bg-[var(--bg-color)]/20 flex flex-col p-5 shrink-0">
             <div className="mb-10 px-1">
                ...
                <span className="text-[9px] text-[var(--text-secondary)] font-bold tracking-[0.2em] uppercase pl-1">Central Repository</span>
             </div>
          ...
          <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                  ...
                  {activeTab === 'commands' && snippets.length > 0 && (
                    <button 
                      ...
                      className={cn(
                        ...
                        selectedSnippetIds.size > 0 ? "border-[var(--accent-primary)] bg-[var(--accent-primary)]/10" : "border-[var(--text-primary)]/10 hover:border-[var(--text-primary)]/20"
                      )}
                    >
            ...
            {activeTab === 'commands' && selectedSnippetIds.size > 0 && (
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-[600px] bg-[var(--surface-color)] border border-[var(--text-primary)]/10 rounded-full py-2 px-8 flex items-center justify-between shadow-[0_30px_60px_rgba(0,0,0,0.8)] animate-in fade-in slide-in-from-bottom-6 duration-500 z-50">
                ...
                <div className="flex items-center gap-4">
                  <button 
                    ...
                    className="text-[10px] font-bold text-[var(--text-secondary)]/70 hover:text-[var(--text-primary)] transition-all uppercase tracking-widest"
                  >
                    Cancel
                  </button>
                  <div className="w-px h-4 bg-[var(--text-primary)]/10" />
                  <Button 
                    variant="destructive" 
                    size="sm" 
