...
export const ArrowExpand01Icon = wrapIcon(HugeIcons.ArrowExpand01Icon);
export const ArrowShrink01Icon = wrapIcon(HugeIcons.ArrowShrink01Icon);
...
export const FolderAdd = wrapIcon(HugeIcons.FolderAddIcon);
...
export const PanelLeft = wrapIcon(HugeIcons.PanelLeftIcon);
export const PanelRight = wrapIcon(HugeIcons.PanelRightIcon);
...
export const ChevronDown = wrapIcon(HugeIcons.ChevronDownIcon);
export const ChevronDownIcon = wrapIcon(HugeIcons.ChevronDownIcon);
export const ChevronUp = wrapIcon(HugeIcons.ChevronUpIcon);
...
export const MoreHorizontal = wrapIcon(HugeIcons.MoreHorizontalIcon);
